using ChampionMod.Items.Weapons;
...
namespace ChampionMod.Projectiles.Melee
{
    public class CorruptKnife : ModProjectile
    {
        ...
        {
            if (Main.rand.Next(5) == 0 || Main.rand.Next(5) == 0)
            {
        ...
        private void UpdateStickyJavelins(NPC target)
        {
            ...
            for (int i = 0; i < Main.maxProjectiles; i++) // Loop all projectiles
            {
                ...
                if (i != projectile.whoAmI // Make sure the looped projectile is not the current javelin
                    ...
                    && currentProjectile.modProjectile is CorruptKnife javelinProjectile // Use a pattern match cast so we can access the projectile like an ExampleJavelinProjectile
            ...
            if (currentJavelinIndex >= MAX_STICKY_JAVELINS)
            {
                ...
                for (int i = 5; i < MAX_STICKY_JAVELINS; i++)
                {
        ...
        public override void AI()
        {
            ...
            {
                drawOffsetX = -19; // These values match the values in SetDefaults
                drawOriginOffsetY = 2;
                drawOriginOffsetX = 10;
            }
            else
        ...
        private void NormalAI()
        {
            ...
            {
                Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, 24,
